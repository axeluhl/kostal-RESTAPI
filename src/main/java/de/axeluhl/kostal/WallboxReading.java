...
class WallboxReading {
    ...
    static enum CableState {
        NO_CABLE(0), CABLE_WITHOUT_CAR(1), UNLOCKED_CABLE_WITHOUT_CAR(2), LOCKED_CABLE_WITH_CAR(3);
    ...
    /**
     * From <a href=
     * "https://www.toyota-tech.eu/aimuploads/f66893c3-0be7-447b-9b3a-5cd2efafe54b/1.Wallbox%20Training%20Toyota.pdf">
     ...
     * <li>Status B2 Vehicle connected, vehicle not ready for charging, plug connections locked/ interrupted by vehicle,
     * vehicle still connected, plug connection locked</li>
     * <li>Status C2 Vehicle ready for charging, charging process starts</li>
     * <li>Status E Electric vehicle not available (fault, short circuit between PE and CP), PWM voltage= 0V (not
     * shown)</li>
